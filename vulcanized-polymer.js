import { Base, html as html$1, Polymer, IronResizableBehavior, dom, animationFrame, Debouncer, enqueueDebouncer, html$1 as html, afterNextRender, IronA11yKeysBehavior, IronOverlayBehavior, IronOverlayBehaviorImpl, NeonAnimationRunnerBehavior, resolveUrl, IronA11yAnnouncer, dashToCamelCase, PolymerElement, findOriginalTarget } from './shared_bundle_1.js';
...
/// BareSpecifier=@polymer\iron-media-query\iron-media-query
Polymer({
  is: 'iron-media-query',
  properties: {
    /**
...
}); /// BareSpecifier=@polymer\app-layout\app-layout-behavior\app-layout-behavior
...
}; /// BareSpecifier=@polymer\app-layout\app-drawer-layout\app-drawer-layout
...
}); /// BareSpecifier=@polymer\app-layout\app-drawer\app-drawer
...
}); /// BareSpecifier=@polymer\app-layout\app-header-layout\app-header-layout
...
}); /// BareSpecifier=@polymer\iron-scroll-target-behavior\iron-scroll-target-behavior
...
}; /// BareSpecifier=@polymer\app-layout\helpers\helpers
...
var helpers = {
  ...
  scroll: scroll
}; /// BareSpecifier=@polymer\app-layout\app-scroll-effects\app-scroll-effects-behavior
...
}; /// BareSpecifier=@polymer\app-layout\app-header\app-header
...
}); /// BareSpecifier=@polymer\app-layout\app-scroll-effects\effects\waterfall
...
}); /// BareSpecifier=@polymer\app-layout\app-toolbar\app-toolbar
...
}; /// BareSpecifier=@polymer\iron-meta\iron-meta
...
document.head.appendChild(template$1.content); /// BareSpecifier=@polymer\iron-icons\communication-icons

const template$2 = html`<iron-iconset-svg name="communication" size="24">
<svg><defs>
...
document.head.appendChild(template$2.content); /// BareSpecifier=@polymer\iron-icons\editor-icons
...
document.head.appendChild(template$3.content); /// BareSpecifier=@polymer\iron-icons\image-icons

const template$4 = html`<iron-iconset-svg name="image" size="24">
<svg><defs>
...
document.head.appendChild(template$4.content); /// BareSpecifier=@polymer\iron-icons\iron-icons
...
document.head.appendChild(template$5.content); /// BareSpecifier=@polymer\iron-icons\social-icons

const template$6 = html`<iron-iconset-svg name="social" size="24">
<svg><defs>
...
document.head.appendChild(template$6.content); /// BareSpecifier=@polymer\iron-image\iron-image
...
var paperInkyFocusBehavior = {
 ...
 /// BareSpecifier=@polymer\paper-button\paper-button

const template$8 = html$1`
...
document.head.appendChild($_documentContainer.content); /// BareSpecifier=@polymer\paper-dropdown-menu\paper-dropdown-menu-shared-styles

const $_documentContainer$1 = document.createElement('template');
$_documentContainer$1.setAttribute('style', 'display: none;');
$_documentContainer$1.innerHTML = `<dom-module id="paper-dropdown-menu-shared-styles">
  <template>
    <style>
      :host {
        display: inline-block;
...
document.head.appendChild($_documentContainer$1.content); /// BareSpecifier=@polymer\paper-input\paper-input-addon-behavior
...
document.body.appendChild(template$a.content); /**
...
$_documentContainer$2.innerHTML = `<dom-module id="paper-item-shared-styles">
  <template>
    <style>
      :host, .paper-item {
        display: block;
...
document.head.appendChild($_documentContainer$2.content); /// BareSpecifier=@polymer\paper-item\paper-item-behavior
...
}); // Must put header effects/waterfall before header/layout

export { appLayoutBehavior as $appLayoutBehavior, appScrollEffectsBehavior as $appScrollEffectsBehavior, helpers as $helpers, ironButtonState as $ironButtonState, ironControlState as $ironControlState, ironFormElementBehavior as $ironFormElementBehavior, ironMenuBehavior as $ironMenuBehavior, ironMeta as $ironMeta, ironScrollTargetBehavior as $ironScrollTargetBehavior, ironMultiSelectable as $ironMultiSelectable, ironSelectable as $ironSelectable, ironSelection as $ironSelection, ironValidatableBehavior as $ironValidatableBehavior, neonAnimationBehavior as $neonAnimationBehavior, paperButtonBehavior as $paperButtonBehavior, paperInkyFocusBehavior as $paperInkyFocusBehavior, paperRippleBehavior as $paperRippleBehavior, paperInputAddonBehavior as $paperInputAddonBehavior, paperInputBehavior as $paperInputBehavior, paperItemBehavior as $paperItemBehavior, paperMenuButton as $paperMenuButton, AppLayoutBehavior, AppScrollEffectsBehavior, _scrollEffects, _scrollTimer, scrollTimingFunction, registerEffect, queryAllRoot, scroll, IronButtonStateImpl, IronButtonState, IronControlState, IronFormElementBehavior, IronMenuBehaviorImpl, IronMenuBehavior, IronMeta, IronScrollTargetBehavior, IronMultiSelectableBehaviorImpl, IronMultiSelectableBehavior, IronSelectableBehavior, IronSelection, IronValidatableBehaviorMeta, IronValidatableBehavior, NeonAnimationBehavior, PaperButtonBehaviorImpl, PaperButtonBehavior, PaperInkyFocusBehaviorImpl, PaperInkyFocusBehavior, PaperRippleBehavior, PaperInputAddonBehavior, PaperInputHelper, PaperInputBehaviorImpl, PaperInputBehavior, PaperItemBehaviorImpl, PaperItemBehavior, PaperMenuButton };